...
namespace Project
{
    public partial class Payment : System.Web.UI.Page
    {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        cartTotal.InnerText = string.Format("{0:#,###.##}", double.Parse(Total));
        ...
        {
            Response.Redirect(String.Format("RazorPayCheckout.aspx?Name={0}&Mobile={1}&txtAmount={2}", txtName.Text, txtMobileNumber.Text, txtAmount.Text));
        }
    }
    }