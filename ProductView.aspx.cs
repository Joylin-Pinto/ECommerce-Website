...
namespace Project
{
    public partial class ProductView : System.Web.UI.Page
    {
        ...
        private void BindProductDetails()
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    sda.Fill(dt);
                    RepeaterProdDetails.DataSource = dt;
                    RepeaterProdDetails.DataBind();
        ...
        protected void RepeaterProdDetails_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                using (SqlConnection con = new SqlConnection(CS))
                {
                    using (SqlCommand cmd = new SqlCommand("select * from tblSize where BrandID='" + BrandID + "' and CategoryId = " + CatID + " and SubCategory = " + SubCatID + " and GenderId = " + GenderID + "", con))
                    {
                        cmd.CommandType = CommandType.Text;
                        using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                        {
        ...
        protected void BtnAddtoCart_Click(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem item in RepeaterProdDetails.Items)
            {
